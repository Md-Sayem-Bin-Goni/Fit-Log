...
const SelectedLibraryCard = ({ library } :  {library: ILibrary}) => {
    ...
    <div className="p-4 sm:p-5 flex flex-col lg:flex-row lg:items-center justify-between gap-5 lg:gap-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 lg:gap-4 shrink-0">
            ...
            >
                <button className="btn btn-outline rounded-full px-5 lg:px-7 border-gray-600 text-gray-200 w-full sm:w-auto">
                    View Details
                </button>
            </Link>
            ...
            <button
                ...
                className={
                    markasdone
                        ? "btn btn-outline rounded-full px-5 lg:px-7 border-green-600 text-green-200 w-full sm:w-auto"
