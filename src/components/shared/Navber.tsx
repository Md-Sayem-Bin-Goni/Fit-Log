        ...
        <nav className="bg-[#0d0f10] border-b border-gray-800 sticky top-0 z-50">
            ...
            <div className="container mx-auto px-4 sm:px-6">
                ...
                <div className="min-h-20 flex flex-wrap items-center justify-between gap-y-3 py-3 md:flex-nowrap md:py-0">
                    ...
                    <ul className="order-3 w-full flex items-center justify-center gap-2 text-sm md:order-2 md:w-auto md:gap-3">
                    ...
                    <div className="order-2 flex items-center gap-3 sm:gap-5 md:order-3 md:gap-7">
